...
class VBO:
    def __init__(self, ctx):
        ...
        self.vbos['building_FIESP'] = BuildingFIESPVBO(ctx)
        self.vbos['building_FIESPbody'] = BuildingFIESPbodyVBO(ctx)
...
class BuildingFIESPVBO(BaseVBO):
    def __init__(self, ctx):
        super().__init__(ctx)
        self.format = '2f 3f 3f'
        self.attribs = ['in_texcoord_0', 'in_normal', 'in_position']
    ...
    def get_vertex_data(self):
        # Vértices ajustados para um paralelepípedo retangular com altura 8 e largura 3
        vertices = [(-2, -4, 3), (3, -1, 3), ( 0,  5, 3), (-2,  6, 3),
                    (-2,  6, -3), (-2, -4, -3), (3, -1, -3), (0,  5, -3)]
...
class BuildingFIESPbodyVBO(BaseVBO):
    def __init__(self, ctx):
        super().__init__(ctx)
        self.format = '2f 3f 3f'
        self.attribs = ['in_texcoord_0', 'in_normal', 'in_position']
